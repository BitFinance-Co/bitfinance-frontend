...
class Experimental extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      search: '',
      searchError: false,
      hideZero: localStorage.getItem('bitfinance-hideZero') === '1' ? true : false,
      loading: true
    }
  ...
  handleChecked = (event) => {
    ...
    localStorage.setItem('bitfinance-hideZero', (event.target.checked ? '1' : '0' ))
  }
    ...
    return(
      <div className={ classes.disaclaimer } style={{ marginTop: '25px', maxWidth: '500px' }}>
        ...
        <Typography variant="body1">
          Yearn is only possible due to community contributions. Vault strategy contributors are rewarded with <b>0.5%</b> of yield generated by the vault. <a href="https://docs.bitfinance/faq#what-are-the-fees" rel="noopener noreferrer" target="_blank">Learn more &rarr;</a>
        </Typography>
      </div>
    )
  }
